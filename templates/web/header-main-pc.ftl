                            ...
                            <div class="div-des-6">
                                ...
                                <#if contentModel.name_product_left_lv2_s?has_content>
                                    ...
                                    <div class="div-des-category">
                                        <span class="subtitle-12" style="text-transform: uppercase;">Sản phẩm nổi
                                            bật</span>
            ...
            <div class="div-content-img ">
                <div class="div-img img-hover-btn" style="">
                    ...
                    <div class="btn-overlay">
                        <a href="${contentModel.url_ing_lv2_s!''}" class="btn-img regular-14 color-white"
                            style="color:white">Khám phá ngay</a>
                    </div>
                </div>
            </div>
        </div>
