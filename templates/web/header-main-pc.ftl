                ...
                <div class="footer-mega-link">
                    <#list contentModel.list_item_header_lv2_o.item as listHeaderItem_footer>
                        <a href="${listHeaderItem_footer.url_item_header_lv2_s!''}" class="div-link-icon">
                            <@crafter.img $field="icon_item_header_lv2_s" src=(listHeaderItem_footer.icon_item_header_lv2_s!"") border=0 />
                            <span class="body-15 color-dark-2"> ${listHeaderItem_footer.name_item_header_lv2_s!""}</span>
