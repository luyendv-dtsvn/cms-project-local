...
<li><a href="#" class="pb-2">${contentModel.name_Header_Slim_s!""}</a>
    ...
    <div class="ruby-col-4 pr-0">
        <div class="div-content-img ">
            <div class="div-img img-hover-btn" style="">
                <@crafter.img $field="img_level_2_s" src=(contentModel.img_level_2_s!"") border=0 />
                <div class="btn-overlay">
                    <a href="${contentModel.url_ing_lv2_s!""}" class="btn-img regular-14 color-white" style="color:white">Khám phá ngay</a>
                </div>
            </div>
        </div>
    </div>
    <div class="ruby-col-12 div-footer-mega">
        <div class="footer-mega-link">
            <#list contentModel.list_item_header_lv2_o.item as listHeaderItem-footer>
                <a href="${listHeaderItem-footer.url_item_header_lv2_s!""}" class="div-link-icon">
                    <@crafter.img $field="icon_item_header_lv2_s" src=(listHeaderItem-footer.icon_item_header_lv2_s!"")
                        border=0 />
