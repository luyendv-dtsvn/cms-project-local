                                                              ...
                                                              <div class="div-content-des">
                                                                <div class="div-des-6">
                                                                  <#if subItem.name_product_left_lv2_s?has_content>  
                                                                      <div class="div-des-title ">
                                                                        <span class="heading-h8">${subItem.name_product_left_lv2_s!}</span>
                                                                        <span class="regular-14">${subItem.description_product_left_lv2_s!}</span>
                                                                      </div>
                                                                ...
                                                                <div class="div-des-6">
                                                                  <#if subItem.name_product_right_lv2_s?has_content>  
                                                                      <div class="div-des-title ">
                                                                        <span class="heading-h8">${subItem.name_product_right_lv2_s!}</span>
                                                                        <span class="regular-14">${subItem.description_product_right_lv2_s!}</span>
                                                                      </div>
                                                                      <div class="div-des-category">
                                                                        <span class="subtitle-12" style="text-transform: uppercase;">Sản phẩm nổi bật</span>  
                                                                        <div class="line-h"></div>
                                                          ...
                                                          <div class="ruby-col-4 pr-0">
                                                            <div class="div-content-img ">
                                                              <div class="div-img img-hover-btn" style="">
                                                                ...
                                                                <@crafter.img $field="img_level_2_s" src=(subItem.img_level_2_s!"") border=0 />
                                                                <div class="btn-overlay">
                                                                  <a href="${subItem.url_ing_lv2_s!""}" class="btn-img regular-14 color-white" style="color:white">Khám phá
                                                                    ngay</a>
                                                                </div>
                                                              </div>
                                                            </div>
                                                          ...
                                                          <div class="ruby-col-12 div-footer-mega">
                                                            <div class="footer-mega-link">
                                                                <#list subItem.list_item_header_lv2_o.item as listHeaderItem-footer>
                                                                    <a href="${listHeaderItem-footer.url_item_header_lv2_s!""}" class="div-link-icon">
                                                                        <@crafter.img $field="icon_item_header_lv2_s" src=(listHeaderItem-footer.icon_item_header_lv2_s!"") border=0 />
                                                                <span class="body-15 color-dark-2">${listHeaderItem-footer.name_item_header_lv2_s!""}</span>
